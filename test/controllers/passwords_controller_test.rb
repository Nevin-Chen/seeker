...
class PasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "create" do
    post passwords_path, params: { username: @user.username, email_address: @user.email_address }
  ...
  test "create for an unknown user redirects but sends no mail" do
    post passwords_path, params: { username: @user.username, mail_address: "missing-user@example.com" }
  ...
  test "update with non matching passwords" do
    ...
    assert_no_changes -> { @user.reload.password_digest } do
      put password_path(token), params: { username: @user.username, password: "no", password_confirmation: "match" }
